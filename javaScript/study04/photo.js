...
var mediaWrap01 = document.getElementById('media01');
var mediaWrap02 = document.getElementById('media02');
...
for (var i = 0; i < todayPhoto.length; i++) {
	...
	imgs.push('<li><img src=' + todayPhoto[i].img + '>'
			+ '<br><font size=1" color="696969">' + todayPhoto[i].title
			+ '</font></li>');

}

mediaWrap01.innerHTML = imgs[0] + imgs[1] + imgs[2] + imgs[3];
mediaWrap02.innerHTML = imgs[4] + imgs[5] + imgs[6] + imgs[7];

var nextBt = document.getElementById("nextBt");
var formerBt = document.getElementById("formerBt");

nextBt.onclick = function() {
	if (mediaWrap02.className = "hide") {
		mediaWrap02.className = "";
		mediaWrap01.className = "hide";
	}
}
formerBt.onclick = function former() {
	if (mediaWrap01.className = "hide") {
		mediaWrap02.className = "hide";
		mediaWrap01.className = "";
	}
}
